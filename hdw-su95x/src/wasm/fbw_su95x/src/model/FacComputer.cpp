...
void FacComputer::step()
{
  ...
  if (FacComputer_U.in.sim_data.computer_running) {
    ...
    rtb_Switch4_f = look2_binlxpw(look2_binlxpw(u0, static_cast<real_T>(rtb_DataTypeConversion2),
      ...
      (FacComputer_U.in.bus_inputs.fmgc_own_bus.fm_cg_percent.Data), FacComputer_P.uDLookupTable2_bp01Data_o,
      FacComputer_P.uDLookupTable2_bp02Data, FacComputer_P.uDLookupTable2_tableData_d,
      FacComputer_P.uDLookupTable2_maxIndex, 28U);
    u0 = FacComputer_P.Gain_Gain_j * rtb_alt;
    ...
    rtb_Switch1_a = look2_binlxpw(u0, rtb_Switch4_f, FacComputer_P.uDLookupTable3_bp01Data_k,
      FacComputer_P.uDLookupTable3_bp02Data, FacComputer_P.uDLookupTable3_tableData_p,
      FacComputer_P.uDLookupTable3_maxIndex, 18U);
    if (rtb_Switch1_a > FacComputer_P.Saturation1_UpperSat_h) {
      rtb_Switch1_a = FacComputer_P.Saturation1_UpperSat_h;
    } else if (rtb_Switch1_a < FacComputer_P.Saturation1_LowerSat_c) {
      rtb_Switch1_a = FacComputer_P.Saturation1_LowerSat_c;
    }
    ...
    rtb_BusAssignment_f_flight_envelope_v_fe_next_kn = look1_binlxpw(rtb_Switch1_a,
      FacComputer_P.uDLookupTable1_bp01Data_h, FacComputer_P.uDLookupTable1_tableData_l, 5U);
    ...
    rtb_Switch4_j = std::fmin(std::fmin(rtb_Y_i, std::sqrt(std::pow((std::pow(FacComputer_P.Constant1_Value_p *
      ...
      * 1479.1), look1_binlxpw(rtb_Switch1_a, FacComputer_P.uDLookupTable_bp01Data_m,
      FacComputer_P.uDLookupTable_tableData_g, 5U));
    ...
    rtb_Switch1_a *= FacComputer_P.Gain_Gain_jm;
