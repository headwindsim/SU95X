...
class FacComputer final
{
 public:
  ...
  struct Parameters_FacComputer_T {
    ...
    real_T uDLookupTable2_tableData_d[84];
    real_T uDLookupTable2_bp01Data_o[28];
    real_T uDLookupTable2_bp02Data[3];
    real_T uDLookupTable3_tableData_p[576];
    real_T uDLookupTable3_bp01Data_k[18];
    ...
    real_T uDLookupTable1_bp01Data_h[6];
    real_T uDLookupTable_tableData_g[6];
