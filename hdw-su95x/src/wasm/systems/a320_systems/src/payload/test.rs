...
fn detailed_test_with_multiple_stops() {
    let mut test_bed = test_bed_with()
        ...
        .with_pax(A320Pax::D, 8)
        .with_pax(A320Pax::E, 10)
        .with_pax_target(A320Pax::A, 14)
        .with_pax_target(A320Pax::B, 13)
        .with_pax_target(A320Pax::C, 12)
        .with_pax_target(A320Pax::D, 20)
        .with_pax_target(A320Pax::E, 18)
        .load_half_cargo()
        .real_board_rate()
        .start_boarding()
        .and_run()
