...
class SimVars {
 public:
  ...
  void initializeVars() {
    ...
    CargoAftBulkActual = register_named_variable("SU95_CARGO_AFT_BULK_LOOSE");
    CargoFwdContainerDesired = register_named_variable("SU95_CARGO_FWD_BAGGAGE_DESIRED");
    CargoAftContainerDesired = register_named_variable("SU95_CARGO_AFT_BAGGAGE_1_DESIRED");
    CargoAftBaggageDesired = register_named_variable("SU95_CARGO_AFT_BAGGAGE_2_DESIRED");
    CargoAftBulkDesired = register_named_variable("SU95_CARGO_AFT_BULK_LOOSE_DESIRED");
