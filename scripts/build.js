...
function createPackageFiles(baseDir, manifestBaseFilename) {
    ...
    const manifestBase = require(path.join(SU95X_SRC, 'base', manifestBaseFilename));
...
createPackageFiles(SU95X_OUT, 'manifest-base.json');
createPackageFiles(SU95X_OUT + '-lock-highlight', 'manifest-base-lock-highlight.json');
